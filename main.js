...
//------------------------------------------------------------------------------------------------------------------------
//import { buildingArray } from "./buildings";
...
export const buildingArray = [sawmill,quarry,mine,coalMine,smeltery,wharehouse,farm,library,simpleHut,lumberjackHut]
...
function createButton(item) {
    ...
    if(item.constructor == building) {
        ...
        document.getElementById(`${item.name}Sell`).onclick = function() {changeBuildingAmount(item,'-')}
    } else {
